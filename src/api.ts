...
export const api={
  ...
  modelTable:(input:Record<string,unknown>)=>request<{draft:OntologySnapshot;validation:ValidationIssue[]}>("/api/ontology/from-table",{method:"POST",body:JSON.stringify(input)}),
